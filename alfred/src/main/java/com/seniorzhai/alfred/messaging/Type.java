...
import com.seniorzhai.alfred.messaging.message.AddJobMessage;
import com.seniorzhai.alfred.messaging.message.CallbackMessage;
import com.seniorzhai.alfred.messaging.message.CancelMessage;
import com.seniorzhai.alfred.messaging.message.CancelResultMessage;
import com.seniorzhai.alfred.messaging.message.CommandMessage;
import com.seniorzhai.alfred.messaging.message.ConstraintChangeMessage;
import com.seniorzhai.alfred.messaging.message.PublicQueryMessage;
import com.seniorzhai.alfred.messaging.message.JobConsumerIdleMessage;
import com.seniorzhai.alfred.messaging.message.RunJobMessage;
import com.seniorzhai.alfred.messaging.message.RunJobResultMessage;
import com.seniorzhai.alfred.messaging.message.SchedulerMessage;
